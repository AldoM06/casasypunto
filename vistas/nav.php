        ...
        <div  class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul  class="navbar-nav ml-auto">
                    <li class="nav-item"><a class="nav-link" href="../CyP/about.php">Conócenos</a></li>
                    <li class="nav-item"><a class="nav-link" href="../CyP/invest.php" >Quiero invertir</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="../CyP/loginview.php">
